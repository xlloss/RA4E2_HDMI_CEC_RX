...
#define CEC_ACTION_SET_TUNER_DIGITAL_SERVICE (13U)
#define CEC_ACTION_SET_TUNER_ANALOGUE_SERVICE (14U)
#define CEC_ACTION_REQ_TUNER_CTL (15U)
#define CEC_ACTION_AUDIO_MODE_REQUEST (16U)
#define CEC_ACTION_SET_AUDIO_RATE (17U)
